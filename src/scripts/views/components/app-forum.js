    ...
    <div class="mx-auto py-20 px-6 md:text-lg">
        ...
        <div class="m-auto lg:w-3/4">
            ...
            <div class="flex py-2 gap-2">
                <input id="search-input" class="w-full rounded-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500" type="text" placeholder="Cari Diskusi">
            </div>
            <!-- Diskusi Baru -->
                ...
                <div class="relative w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="px-6 py-6 lg:px-8">
                            ...
                            <form id="create-form" class="space-y-6" action="#">
                                <div>
                                ...
                                <button type="submit" id="create" class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Buat Diskusi</button>
                            </form>
                        </div>
                    </div>
                </div>
