  ...
  render() {
    ...
    <div data-aos="fade-down"
                ...
                <div class="flex flex-wrap justify-center gap-4">
                    <!-- Panduan 1 -->
                    <div data-aos="flip-right" class="max-w-sm p-6 text-center">
                    ...
                    <!-- Panduan 2 -->
                    <div data-aos="flip-up" class="max-w-sm p-6 text-center">
                    ...
                    <!-- Panduan 3 -->
                    <div data-aos="flip-left" class="max-w-sm p-6 text-center">
