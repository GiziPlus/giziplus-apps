  ...
  render() {
    this.innerHTML = `
      ...
      <div id="status" class="flex flex-wrap flex-row-reverse justify-center items-center pt-20 py-8 px-2 md:gap-8 md:py-24">
          <img data-aos="fade-left" data-aos-delay="50" class="w-3/4 md:w-1/2 lg:max-w-lg" src="exams-animate.svg" alt="Tes Gizi" width="400">
          <div data-aos="fade-right" data-aos-delay="50" class="flex flex-wrap justify-center text-black py-6 max-w-lg lg:justify-normal md:text-lg md:py-0">
