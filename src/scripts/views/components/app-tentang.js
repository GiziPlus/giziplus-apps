class AppTentang extends HTMLElement {
  ...
  render() {
    ...
    <!-- Tentang Kami -->
        <section class="pt-16">
            <div class="flex flex-col justify-center px-6 py-6 m-6 bg-gray-100 md:flex-row-reverse md:mx-16">
        ...
        <!-- Tentang Aplikasi -->
        <section>
            <div class="flex flex-wrap justify-center pb-10 px-6 mx-auto max-w-screen-xl gap-4 md:pb-24 md:pt-12 md:mx-16 text-center">
                <div class="flex justify-center text-center flex-col p-4">
                    <h3
                        class="text-2xl font-bold after:block after:content-[''] after:mt-4 after:h-1 after:bg-gradient-to-r from-primary to-secondary after:scale-x-125">
                        Tentang Aplikasi</h3>
                </div>
