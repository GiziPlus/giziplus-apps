...
<div class="md:px-32 px-6 mt-2 mb-8 grid grid-cols-1 gap-2 lg:grid-cols-3 md:grid-cols-2">
                <div class=" mx-auto bg-white border border-gray-200 rounded-lg shadow">
                    <a href="#">
                        <img class="object-cover max-h-56 w-full mx-auto sm:min-w-[300px]" src="/public/gizi-plus-logo/png/logo-white.png" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
...
export { creteArticleItemtemplate };
